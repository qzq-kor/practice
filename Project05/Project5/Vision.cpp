...
void CVision::Load_Image(int ImageNumber, int SelectScreen)
{
	MimResize(MilImage[SelectScreen], MilImageDisp[SelectScreen], DISP2_IMG_RATE_X, DISP2_IMG_RATE_Y, M_DEFAULT);
}
